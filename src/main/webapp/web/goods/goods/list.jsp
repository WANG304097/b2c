...
<div class="layui-form-item" pane>
	...
	<script type="text/javascript">
											...
											$.each(
															...
															function(i, dom) {
																...
																html += "<tr><td>"
																		...
																		+"<input type='button' class='layui-btn' onclick='openUserImg(\""+code+"\")' value='图片维护' />&nbsp;"
		...
		function openUserAdd() {
			...
			openLayer('/web/goods/goods/add.jsp', refresh);
		}

		function openUserUpd(code) {

			openLayer('/web/goods/goods/userupd.jsp?code=' + code, refresh)
		}
		function openUserImg(code){
			// alert(code)
			openLayer('/web/goods/goods/pic.jsp?goodsCode='+code,refresh)
